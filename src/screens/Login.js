  ...
  return (
    ...
    >
      <Image
        ...
        source={
          isDarkMode
            ? require("../../assets/Logo_Variants/ProcrastiMate-logos_white.png")
            : require("../../assets/Logo_Variants/ProcrastiMate-logos_black.png")
        }
      />
      <Text
        style={[
      ...
      />
      <RegisterButton
        colorTheme={isDarkMode ? darkColor : "white"}
